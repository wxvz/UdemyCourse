...
<body>
    <div class="container">
        ...
        if(isset($_POST['update'])) {
            ...
            $update_query = "UPDATE std SET fname='$fname', lname='$lname', guardian='$fathername', email='$email', gender='$gender', std_subject='$subject', country='$country', city='$city', dob='$dob', std_address='$address', picture='$picture' WHERE id='$id'";
